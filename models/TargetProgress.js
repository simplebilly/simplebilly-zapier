...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}progress_pct`,
                label: `Current year's emissions for the scope as % of the target. None when no data. - [${labelPrefix}progress_pct]`,
                type: 'number',
            },
            {
                key: `${keyPrefix}scope`,
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'progress_pct': bundle.inputData?.[`${keyPrefix}progress_pct`],
