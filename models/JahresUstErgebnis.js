...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}gespeicherte_perioden`,
                label: `[${labelPrefix}gespeicherte_perioden]`,
                required: true,
                type: 'integer',
            },
            {
                key: `${keyPrefix}hat_ig_transaktionen`,
                label: `[${labelPrefix}hat_ig_transaktionen]`,
                required: true,
                type: 'boolean',
            },
            {
            ...
            {
                key: `${keyPrefix}restschuld`,
                label: `[${labelPrefix}restschuld]`,
                required: true,
                type: 'string',
            },
            {
                key: `${keyPrefix}summe_vorauszahlungen`,
                label: `[${labelPrefix}summe_vorauszahlungen]`,
                required: true,
                type: 'string',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'gespeicherte_perioden': bundle.inputData?.[`${keyPrefix}gespeicherte_perioden`],
            'hat_ig_transaktionen': bundle.inputData?.[`${keyPrefix}hat_ig_transaktionen`],
            ...
            'kz_48': bundle.inputData?.[`${keyPrefix}kz_48`],
            ...
            'restschuld': bundle.inputData?.[`${keyPrefix}restschuld`],
            'summe_vorauszahlungen': bundle.inputData?.[`${keyPrefix}summe_vorauszahlungen`],
